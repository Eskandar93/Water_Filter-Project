...
public class OtpService {
    ...
    @Transactional
    public boolean isValidOtp(Users user, String otpCode, OtpType type) {
        
        LocalDateTime now = LocalDateTime.now();
        Optional<Otp> curOtp = otpRepository.findByCodeAndUserIdAndTypeAndExpiresAtAfter(otpCode, user.getId(), type, now);
