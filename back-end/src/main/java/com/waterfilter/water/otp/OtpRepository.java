...
public interface OtpRepository extends JpaRepository<Otp, Long>{
    ...
    Optional<Otp> findByCodeAndType(String otpCode, OtpType otpType);

    Optional<Otp> findByCodeAndTypeAndVerifiedIsFalseAndExpiresAtAfter(String otpCode, OtpType type, LocalDateTime now);
}
